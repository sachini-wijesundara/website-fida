...
export default function EditTemplatePage() {
  ...
  return (
    <div className="space-y-8 max-w-5xl mx-auto pb-20">
      <header className="flex items-center justify-between sticky top-4 z-50 bg-[var(--bg-surface)]/95 backdrop-blur-xl p-4 sm:p-6 rounded-2xl border border-[var(--grey-dark)] shadow-md mb-8">
        <div>
          <Link href="/admin/solutions" className="text-blue-500 hover:underline flex items-center gap-2 mb-2">
            <ArrowLeft size={16} /> Back to Solutions
          </Link>
          <h2 className="text-2xl sm:text-3xl font-bold tracking-tight">
            {solutionInfo 
              ? `Edit: ${solutionInfo.title}`
              : "Edit Solution"}
          </h2>
        </div>
        <button
          onClick={handleSave}
          disabled={saving}
          className="flex items-center gap-2 px-6 py-3 rounded-xl bg-gradient-to-r from-blue-500 to-blue-700 text-white font-bold transition-smooth hover:scale-[1.02] shadow-[0_0_15px_rgba(59,130,246,0.5)] disabled:opacity-50"
        >
      ...
      <section className="glass rounded-3xl p-8 border border-[var(--grey-dark)]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
          <div className="space-y-2">
            ...
            <input 
              ...
              className="w-full bg-white border border-slate-200 shadow-sm text-slate-800 rounded-xl px-4 py-3 text-sm focus:border-blue-500 outline-none" 
            />
          </div>
          <div className="space-y-2">
        ...
        <div className="space-y-2 mb-6">
          ...
          <textarea 
            ...
            className="w-full bg-white border border-slate-200 shadow-sm text-slate-800 rounded-xl px-4 py-3 text-sm focus:border-blue-500 outline-none resize-none" 
          />
        </div>
        <div className="space-y-4 mb-6">
          ...
          {template.hero?.features?.map((feat: string, idx: number) => (
            <div key={idx} className="flex gap-2">
              <input 
                ...
                className="flex-1 bg-white border border-slate-200 shadow-sm text-slate-800 rounded-xl px-4 py-3 text-sm focus:border-blue-500 outline-none" 
              />
              <button onClick={() => {
                  const newFeat = [...(template.hero.features || [])];
      ...
      {/* Features Section */}
      <section className="glass rounded-3xl p-8 border border-[var(--grey-dark)]">
        <h3 className="text-xl font-bold mb-6 border-b border-slate-200 pb-4">Features List</h3>
        ...
        <div className="space-y-8">
          {template.features_section?.cards?.map((card: any, idx: number) => (
            <div key={idx} className="p-6 bg-slate-50 border border-slate-200 shadow-sm relative">
              <div className="flex justify-between items-center mb-4">
                ...
                <button 
                  ...
                  className="p-2 bg-red-500/10 text-red-500 hover:bg-red-500 hover:text-blue-500 rounded-lg transition-colors"
                  title="Remove Card"
                >
                  <Trash2 size={16} />
                </button>
          ...
          <button 
            ...
            className="w-full py-4 border-2 border-dashed border-slate-300 rounded-2xl text-[var(--text-muted)] hover:text-blue-500 hover:border-blue-400 transition-colors flex items-center justify-center gap-2 font-bold"
          >
      ...
      {/* Stats Section */}
      <section className="glass rounded-3xl p-8 border border-[var(--grey-dark)]">
        <h3 className="text-xl font-bold mb-6 border-b border-slate-200 pb-4">Statistics Block</h3>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
          <div className="space-y-2">
      ...
      {/* Footer Line */}
      <section className="glass rounded-3xl p-8 border border-[var(--grey-dark)]">
        <h3 className="text-xl font-bold mb-6 border-b border-slate-200 pb-4">Footer Highlight</h3>
        <div className="space-y-2">
